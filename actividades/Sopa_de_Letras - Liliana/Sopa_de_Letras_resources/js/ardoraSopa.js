...
if (j==0){$("#audio1").get(0).play();}
if (j==1){$("#audio2").get(0).play();}
if (j==2){$("#audio3").get(0).play();}
if (j==3){$("#audio4").get(0).play();}
if (j==4){$("#audio5").get(0).play();}
if (j==5){$("#audio6").get(0).play();}
...
function paintList(context){var title="Palabra";context.font = "12px "+fActi;var widthWords=context.measureText(title).width+20;
...
$("#idDiv0").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Sopa_de_Letras_resources/media/Feliz emoticon.jpg");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;});
$("#idDiv1").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Sopa_de_Letras_resources/media/Feliz emoticon.jpg");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;});
$("#idDiv2").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Sopa_de_Letras_resources/media/Feliz emoticon.jpg");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;});
$("#idDiv3").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Sopa_de_Letras_resources/media/Feliz emoticon.jpg");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;});
$("#idDiv4").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Sopa_de_Letras_resources/media/Feliz emoticon.jpg");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;});
$("#idDiv5").hover(function(){$(this).css("cursor","pointer");
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"Sopa_de_Letras_resources/media/Feliz emoticon.jpg");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;});
}
function defAudioDivs(){
$("#idDiv0").click(function() {$("#audio1").get(0).play();});
$("#idDiv1").click(function() {$("#audio2").get(0).play();});
$("#idDiv2").click(function() {$("#audio3").get(0).play();});
$("#idDiv3").click(function() {$("#audio4").get(0).play();});
$("#idDiv4").click(function() {$("#audio5").get(0).play();});
$("#idDiv5").click(function() {$("#audio6").get(0).play();});
}
function paintImaDivs(x,y,imageSrc){
while(y+40>$("#ardoraActSel").height()){y=y-1};while(x+40>$("#ardoraActSel").width()){x=x-1};
var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");
var imageObj = new Image();imageObj.src = imageSrc;imageObj.onload = function() {context.drawImage(imageObj,x,y);};}
