...
function messagePlayAudio(typeMessage){ if (typeMessage=="Ok"){document.getElementById("audioFelicitacion").play()} if (typeMessage=="Time"){document.getElementById("audioTempo").play()}}
