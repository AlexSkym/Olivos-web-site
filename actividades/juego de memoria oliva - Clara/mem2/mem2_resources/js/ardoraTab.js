...
contexto.fillRect(0,0,canvas.width,canvas.height); contexto.font="25px " + fMenssage; var metricsW = contexto.measureText(textMessage).width;var x=(canvas.width / 2)-(metricsW / 2);var y=(canvas.height / 2);
...
function messagePlayAudio(typeMessage){ if (typeMessage=="Ok"){document.getElementById("audioFelicitacion").play()} if (typeMessage=="Time"){document.getElementById("audioTempo").play()} if (typeMessage=="Attempts"){document.getElementById("audioIntentos").play()}}
...
contexto.font="25px " + fMenssage ;var metricsW = contexto.measureText(textButtonTime).width;var x=(canvas.width / 2)-(metricsW / 2);var y=(canvas.height / 2);
